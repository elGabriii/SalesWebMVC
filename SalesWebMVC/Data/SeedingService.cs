...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Gabriel", "gabriel@mail.com", new DateTime(1997, 3, 8), 1000, d1);
            Seller s2 = new Seller(2, "Carla", "carla@mail.com", new DateTime(1973, 1, 1), 600, d2);
            Seller s3 = new Seller(3, "Diogo", "diogo@mail.com", new DateTime(1997, 11, 21), 800, d1);
            Seller s4 = new Seller(4, "Carlos", "carlos@mail.com", new DateTime(1997, 7, 24), 1000, d4);
            Seller s5 = new Seller(5, "Fred", "fred@mail.com", new DateTime(1997, 1, 21), 700, d3);
            Seller s6 = new Seller(6, "Nadine", "nadine@mail.com", new DateTime(1997, 3, 29), 10000, d3);
